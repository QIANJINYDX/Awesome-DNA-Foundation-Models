...
| Representative sources | Corpus tag | Data composition | Links |
| --- | --- | --- | --- |
| GRCh38/hg38 | ![Single-species](https://img.shields.io/badge/Corpus-Single--species_reference-15803d) | Human reference assembly used as the dominant coordinate system for reference-sequence pretraining and many human regulatory benchmarks. | [NCBI Datasets](https://www.ncbi.nlm.nih.gov/datasets/genome/GCF_000001405.40/)<br>[UCSC hg38](https://genome.ucsc.edu/cgi-bin/hgGateway?db=hg38) |
| T2T-CHM13 | ![Single-species](https://img.shields.io/badge/Corpus-Single--species_reference-15803d) | Gapless telomere-to-telomere human assembly resolving centromeres, acrocentric short arms, segmental duplications, and other previously missing regions. | [NCBI Datasets](https://www.ncbi.nlm.nih.gov/datasets/genome/GCF_009914755.1/) |
| hg19 | ![Single-species](https://img.shields.io/badge/Corpus-Single--species_reference-15803d) | Legacy GRCh37/UCSC human reference widely used by older epigenomic annotations, regulatory datasets, and benchmark splits. | [UCSC hg19](https://genome.ucsc.edu/cgi-bin/hgGateway?db=hg19) |
| mm10/mm39 | ![Single-species](https://img.shields.io/badge/Corpus-Single--species_reference-15803d) | Mouse reference assemblies used for mammalian regulatory sequence modeling, mouse functional genomics tracks, and cross-species transfer. | [UCSC mm10](https://genome.ucsc.edu/cgi-bin/hgGateway?db=mm10)<br>[UCSC mm39](https://genome.ucsc.edu/cgi-bin/hgGateway?db=mm39) |
| TAIR10 | ![Single-species](https://img.shields.io/badge/Corpus-Single--species_reference-15803d) | Arabidopsis thaliana reference genome and gene annotation baseline for plant sequence-function datasets. | [TAIR10 release](https://www.arabidopsis.org/download/index-auto.jsp?dir=%2Fdownload_files%2FGenes%2FTAIR10_genome_release) |
| 1000 Genomes Project | ![Population-scale](https://img.shields.io/badge/Corpus-Population--scale_variant--aware-2563eb) | Phased human variants and haplotypes across global populations, enabling allele-specific or variant-aware sequence construction. | [Project portal](https://www.internationalgenome.org/) |
| 3,202 high-coverage human genomes | ![Population-scale](https://img.shields.io/badge/Corpus-Population--scale_variant--aware-2563eb) | High-depth 1000 Genomes GRCh38 call set with SNVs, indels, and structural variants for population-scale sequence variation. | [30x GRCh38 call set](https://www.internationalgenome.org/data-portal/data-collection/30x-grch38) |
| Human Pangenome Reference Consortium | ![Population-scale](https://img.shields.io/badge/Corpus-Population--scale_variant--aware-2563eb) | Haplotype-resolved human pangenome assemblies and graph references capturing alternatives absent from a single linear reference. | [Project portal](https://humanpangenome.org/) |
| Ensembl Genomes | ![Multi-species](https://img.shields.io/badge/Corpus-Multi--species_reference-0f766e) | Comparative genome and annotation resource for non-vertebrate eukaryotes, bacteria, plants, fungi, protists, and metazoa. | [Portal](https://ensemblgenomes.org/) |
| NCBI RefSeq | ![Multi-species](https://img.shields.io/badge/Corpus-Multi--species_reference-0f766e) | Curated reference sequences and genome assemblies with standardised annotation across taxa. | [RefSeq](https://www.ncbi.nlm.nih.gov/refseq/) |
| NCBI GenBank | ![Multi-species](https://img.shields.io/badge/Corpus-Multi--species_reference-0f766e) | Primary archival nucleotide sequence database containing submitted genomic sequences and assemblies before RefSeq curation. | [GenBank](https://www.ncbi.nlm.nih.gov/genbank/) |
| Phytozome | ![Multi-species](https://img.shields.io/badge/Corpus-Multi--species_reference-0f766e) | JGI plant comparative genomics portal with plant genome assemblies, gene models, families, and functional annotations. | [Portal](https://phytozome-next.jgi.doe.gov/) |
| OpenGenome | ![Prokaryotic/phage](https://img.shields.io/badge/Corpus-Prokaryotic%2FPhage-ca8a04) | Evo pretraining corpus of prokaryotic and phage whole-genome sequences at single-nucleotide resolution. | [Dataset](https://huggingface.co/datasets/LongSafari/open-genome) |
| NCBI RefSeq Bacteria/Archaea | ![Prokaryotic/phage](https://img.shields.io/badge/Corpus-Prokaryotic%2FPhage-ca8a04) | Curated bacterial and archaeal assemblies and annotations used for microbial genome representation. | [RefSeq prokaryotes](https://www.ncbi.nlm.nih.gov/refseq/about/prokaryotes/) |
| GenBank Prokaryotic Genomes | ![Prokaryotic/phage](https://img.shields.io/badge/Corpus-Prokaryotic%2FPhage-ca8a04) | Broad submitted prokaryotic genome assemblies, including draft genomes and isolates with variable curation status. | [NCBI Genome browser](https://www.ncbi.nlm.nih.gov/genome/browse#!/prokaryotes/) |
| IMG/VR | ![Prokaryotic/phage](https://img.shields.io/badge/Corpus-Prokaryotic%2FPhage-ca8a04) | Viral genome catalogue from isolate and metagenomic data, useful for phage-inclusive microbial pretraining. | [IMG/VR](https://img.jgi.doe.gov/vr/) |
| GenomeOcean corpus | ![Metagenomic](https://img.shields.io/badge/Corpus-Metagenomic_environmental-854d0e) | Large-scale metagenomic assemblies used by GenomeOcean, emphasising microbial contigs from environmental and host-associated samples. | [Repository](https://github.com/jgi-genomeocean/genomeocean)<br>[Paper](https://www.biorxiv.org/content/10.1101/2025.01.30.635558v2) |
| IMG/M | ![Metagenomic](https://img.shields.io/badge/Corpus-Metagenomic_environmental-854d0e) | Integrated microbial genomes and microbiomes resource with metagenome projects, MAGs, isolate genomes, and functional annotations. | [IMG/M](https://img.jgi.doe.gov/m/) |
| MGnify | ![Metagenomic](https://img.shields.io/badge/Corpus-Metagenomic_environmental-854d0e) | EMBL-EBI metagenomics resource with assembled contigs, annotations, taxonomic profiles, and biome metadata. | [MGnify](https://www.ebi.ac.uk/metagenomics/) |
| JGI Metagenome | ![Metagenomic](https://img.shields.io/badge/Corpus-Metagenomic_environmental-854d0e) | JGI project portal for environmental sequencing projects and metagenomic datasets feeding IMG/M-style resources. | [JGI portal](https://genome.jgi.doe.gov/portal/) |
| GOLD | ![Metagenomic](https://img.shields.io/badge/Corpus-Metagenomic_environmental-854d0e) | Genome Online Database metadata catalogue for genome and metagenome projects, sampling environments, sequencing status, and study metadata. | [GOLD](https://gold.jgi.doe.gov/) |
| Tara Oceans | ![Metagenomic](https://img.shields.io/badge/Corpus-Metagenomic_environmental-854d0e) | Marine microbial, viral, and plankton omics samples from global ocean expeditions, available through ENA project records. | [ENA PRJEB402](https://www.ebi.ac.uk/ena/browser/view/PRJEB402) |
| NCBI Virus | ![Viral/mobile](https://img.shields.io/badge/Corpus-Viral_mobile_elements-b91c1c) | Curated virus sequence portal with genome records, isolate metadata, host information, and sequence downloads. | [NCBI Virus](https://www.ncbi.nlm.nih.gov/labs/virus/vssi/#/) |
| GenBank Viral | ![Viral/mobile](https://img.shields.io/badge/Corpus-Viral_mobile_elements-b91c1c) | Submitted viral nucleotide records in GenBank, covering complete genomes, segments, isolates, and partial viral sequences. | [GenBank](https://www.ncbi.nlm.nih.gov/genbank/) |
| IMG/VR | ![Viral/mobile](https://img.shields.io/badge/Corpus-Viral_mobile_elements-b91c1c) | Viral isolate and metagenomic sequence catalogue supporting phage and environmental viral genome discovery. | [IMG/VR](https://img.jgi.doe.gov/vr/) |
| PhagesDB | ![Viral/mobile](https://img.shields.io/badge/Corpus-Viral_mobile_elements-b91c1c) | Community phage database with bacteriophage genomes, host annotations, clusters, and related metadata. | [PhagesDB](https://phagesdb.org/) |
| PLSDB | ![Viral/mobile](https://img.shields.io/badge/Corpus-Viral_mobile_elements-b91c1c) | Curated plasmid database containing plasmid sequences, host information, and metadata for mobile genetic element studies. | [PLSDB](https://ccb-microbe.cs.uni-saarland.de/plsdb/) |
| OpenGenome2 | ![Cross-domain](https://img.shields.io/badge/Corpus-Cross--domain_pan--genomic-4338ca) | Cross-domain Evo 2 pretraining corpus spanning bacteria, archaea, eukaryotes, viruses, organelles, and metagenomic sequence. | [Dataset](https://huggingface.co/datasets/arcinstitute/opengenome2) |
